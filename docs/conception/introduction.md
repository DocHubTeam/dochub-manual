# DocHub - платформа цифрового развития организации

DocHub создан в ответ на актуальные вызовы в управлении архитектурой предприятий и ИТ систем.
В его основе лежит концепция "Архитектура как код", что позволяет рассматривать архитектурные артефакты — такие как документы
и диаграммы — как приложения, компилируемые из кода архитектуры. Это свойство открывает возможность применения проверенных практик
разработки программного обеспечения для эффективного управления архитектурой и бесшовной интеграции в производственный процесс
разработки.
