...
Презентации позволяют генерировать представления объектов. Это могут быть диаграммы, svg картинки,
terraform код и т.п. Ассортимент презентаций определяется подключенными плагинами. DocHub имеет
[широкий базовый состав презентаций](@document/dochub.presentations), который вы можете расширять.
