...
![test](@document/dochub.example.bpmn.full)
...
* [Визуальные редакторы диаграмм](@document/@document/dochub.excalidraw);
...
"мета-пакетами". Они подключаются по мере необходимости для достижения конкретных целей, что позволяет добиваться оптимальных результатов
