...
описывающую её структуру, процессы и ресурсы. Эта модель не просто хранит данные, но и может исполняться аналогично приложению, что 
значительно расширяет возможности анализ, управления и прогнозирования.
...
* [Визуальные редакторы диаграмм](@document/dochub.presentations.excalidraw);
* [Редакторы документов](@document/dochub.presentations.wysiwyg);
