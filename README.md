...
1. Визуальные редакторы диаграмм;
2. Редакторы документов;
3. Пользовательские формы.

Это становится возможным благодаря уникальной концепции метамодели DocHub. В нем метамодель представляет собой базовый кодовый
слой, который по своим характеристикам аналогичен модулям приложений. Эти модули в DocHub называются "мета-пакетами". Они подключаются по
мере необходимости для достижения конкретных целей, что позволяет добиваться оптимальных результатов в кратчайшие сроки. Большинство
пользовательских сценариев можно реализовать, развивая метамодель.
